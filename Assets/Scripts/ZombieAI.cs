...
public class ZombieAI : MonoBehaviour {
	...
	void RandomWalk ()
	{
        ...
        {
            Vector3 position = new Vector3(Random.Range(upperLeftCorner.position.x, lowerRightCorner.position.x), 0, 
                                           Random.Range(lowerRightCorner.position.z, upperLeftCorner.position.z));
